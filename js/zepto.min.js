...
window.Zepto = Zepto, void 0 === window.$ && (window.$ = Zepto),
    ...
    function (a) {
        ...
        a.active = 0, a.ajaxJSONP = function (d, e) {
            ...
            var g, h, x, i, j, l, m, o, s, y, c = a.extend({}, b || {}),
            ...
            if (i = c.accepts[g], j = {}, l = function (a, b) {
                    j[a.toLowerCase()] = [a, b]
                }, m = /^([\w-]+:)\/\//.test(c.url) ? RegExp.$1 : window.location.protocol, o = c.xhr(), s = o.setRequestHeader, f && f.promise(o), c.crossDomain || l("X-Requested-With", "XMLHttpRequest"), l("Accept", i || "*/*"), (i = c.mimeType || i) && (i.indexOf(",") > -1 && (i = i.split(",", 2)[0]), o.overrideMimeType && o.overrideMimeType(i)), (c.contentType || c.contentType !== !1 && c.data && "GET" != c.type.toUpperCase()) && l("Content-Type", c.contentType || "application/x-www-form-urlencoded"), c.headers)
    ...
    function (a, b) {
        ...
        a.each(g, function (a, e) {
            ...
            var h, v, y, i = {},
                ...
                A = !1;
            if (d === b && (d = a.fx.speeds._default / 1e3), g === b && (g = 0), a.fx.off && (d = 0), "string" == typeof c) i[p] = c, i[q] = d + "s", i[s] = g + "s", i[r] = e || "linear", z = a.fx.animationEnd;
            else {
                v = [];
